...
try:
    ...
    rasa_sdk_version = "not installed"

logger = logging.getLogger(__name__)


def create_argument_parser() -> argparse.ArgumentParser:
    """Parse command line arguments for the AdaOS NLU slice."""
    parser = argparse.ArgumentParser(
        prog="rasa",
        formatter_class=argparse.ArgumentDefaultsHelpFormatter,
        description=(
            "AdaOS Rasa NLU command line interface. This trimmed integration "
            "keeps the training and parsing stack needed by AdaOS NLU."
        ),
    )
    ...
    subparsers = parser.add_subparsers(help="Rasa NLU commands")
...
def print_version() -> None:
    """Print version information for rasa tooling and python."""
...
def main() -> None:
    """Run the trimmed AdaOS Rasa NLU command line application."""
